        ...
        <table className="w-full text-left border-collapse border">
            <thead className="text-center">
                <tr className="uppercase text-sm leading-normal">
                    ...
                    <th rowSpan={2} className="px-2 border table-cell">
                        Pelanggan
                    </th>
                    <th rowSpan={2} className="px-2 border table-cell">
                        Alamat
                    ...
                    <th
                        rowSpan={2}
                        className="px-2 border w-[1px] hidden md:table-cell"
                    >
                        Total
                    </th>
                    <th
                ...
                <tr className="uppercase text-sm leading-normal hidden md:table-row">
                    ...
                    <th className="px-2 border">Transaksi</th>
                </tr>
            </thead>
                ...
                {loading ? (
                    ...
                    dataTable.map((value: any, index: number) => (
                        ...
                        >
                            ...
                            <td className="px-2 py-1 border hidden md:table-cell">
                                {value.paket_internet}
                            </td>
                            <td className="px-2 py-1 border hidden md:table-cell">
                                <span>
                                    {value?.tanggal_pembayaran?.tanggal}
                                </span>
                                <br className="m-0" />
                                <span className="text-xs">
                                    {value?.tanggal_pembayaran?.jam}
                                </span>
                            </td>
                            <td className="px-2 py-1 border hidden md:table-cell">
