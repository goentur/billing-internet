						...
						<div ref={contentRef} className="w-[80mm] p-0 m-0 border border-dashed font-mono">
							...
							<table className="w-full text-xs border-collapse">
								<tbody>
									...
									<tr>
										<td className='w-[1px] align-top font-bold'>PEGAWAI</td>
										<td className='align-top'>:</td>
										<td className='text-start'>{dataPrint?.user ?? '-'}</td>
									</tr>
									<tr>
										<td className='align-top font-bold'>TANGGAL</td>
										<td className='align-top'>:</td>
										<td className='text-start'>{dataPrint?.tanggal_transaksi ?? '-'}</td>
									</tr>
									<tr>
							...
							<table className="w-full text-xs border-collapse">
								<tbody>
									<tr>
										<td className='align-top font-bold'>PELANGGAN</td>
										<td className='align-top'>:</td>
										<td>{dataPrint?.pelanggan?.nama ?? '-'}</td>
									</tr>
									<tr>
										<td className='align-top font-bold'>ALAMAT</td>
										<td className='align-top'>:</td>
										<td>{dataPrint?.pelanggan?.alamat ?? '-'}</td>
									</tr>
									<tr>
										<td className='align-top font-bold'>KETENGAN</td>
										<td className='align-top'>:</td>
										<td>Bayar internet untuk bulan {dataPrint?.tanggal_pembayaran ?? '-'}</td>
									</tr>
									<tr className='font-bold'>
										<td className='align-top font-bold'>NOMINAL</td>
										<td className='align-top'>:</td>
									...
									<tr>
										<td colSpan={3} className='italic text-[10px]'>
