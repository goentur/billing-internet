...
export default function Index() {
    ...
    return (
        <AuthenticatedLayout header={judul}>
            ...
            <FormDialog open={form} setOpen={setForm} judul={judul} data={data} setData={setData} errors={errors} formRefs={formRefs} processing={processing} simpanAtauUbah={handleSubmit} dataPermissions={dataPermissions} />
