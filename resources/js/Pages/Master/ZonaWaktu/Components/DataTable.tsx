                ...
                <tr key={index} className="hover:bg-gray-100 dark:hover:bg-slate-900">
                    ...
                    <td className="border text-center">
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent>
                                {gate.update && <DropdownMenuItem onClick={() => {setForm(true), setIsEdit(true), setData({ id:value.id, nama:value.nama, singkatan:value.singkatan, gmt_offset:value.gmt_offset})}}><Pencil/> Ubah</DropdownMenuItem>}
